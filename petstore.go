...
package testpetstore

import (
	"fmt"
	"github.com/speakeasy-sdks/test-petstore/internal/hooks"
	"github.com/speakeasy-sdks/test-petstore/pkg/utils"
	"net/http"
	"time"
)
...
func New(opts ...SDKOption) *Petstore {
	sdk := &Petstore{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.6.2",
			GenVersion:        "2.272.4",
			UserAgent:         "speakeasy-sdk/go 0.6.2 2.272.4 1.0.0 github.com/speakeasy-sdks/test-petstore",
			Hooks:             hooks.New(),
		},
	}
